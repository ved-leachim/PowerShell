...
$SPOLicensePlanListName = "A5 Staff License Plan" # SPO List Name where License Plan is stored
$TeamsInfoHook = "https://bernerfachhochschule.webhook.office.com/webhookb2/efdfa6c5-5fda-4b1d-a6a8-53578dd83334@d6a1cf8c-768e-4187-a738-b6e50c4deb4a/IncomingWebhook/cdda2949c8fb4fe094da7ef6e050a79e/a7ed577e-a521-4e59-a98a-2dbb23cab82a"
$TeamsErrorHook = "https://bernerfachhochschule.webhook.office.com/webhookb2/efdfa6c5-5fda-4b1d-a6a8-53578dd83334@d6a1cf8c-768e-4187-a738-b6e50c4deb4a/IncomingWebhook/6e429db52ce849bd8981f948a538ef36/a7ed577e-a521-4e59-a98a-2dbb23cab82a"
...
$A5StaffRunBookUrl = "https://portal.azure.com/#@bfh.ch/resource/subscriptions/9c7b5314-4996-4f12-833d-bdcb4177095a/resourceGroups/BFH90INFRSG004/providers/Microsoft.Automation/automationAccounts/MS365-Automation/runbooks/Set-A5-Staff-Licenses/overview"
#-------------------------------------------------------------#
...
Function Set-MailboxSettings() {
    ...
    ForEach ($User in $NewlySynchedUsers) {
        ...
        if ($HasFailed) {
            ...
            ` SetCalendarPermissions   =   $($UserMailboxState.SetCalendarPermissions)
